...
FFHQ: Download the [Flickr-Faces-HQ dataset](https://github.com/NVlabs/stylegan3#:~:text=Flickr-Faces-HQ%20dataset) as 1024x1024 images and create a zip archive using dataset_tool.py: https://github.com/NVlabs/stylegan3#:~:text=Flickr-Faces-HQ%20dataset
